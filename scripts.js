...
if (asterNum.ready === true){
  console.log("reached in if statement");

clear();

image(img, 0, 0);

if (circles.length !== asterNum.apiData){
console.log('woop');
for (var e = (circles.length - 1);e >=0 ;e--){
  console.log('reached here');
  removeSprite(circles.get(e));
  circles.splice(e, 1);
} 

for(var m=0; m<asterNum.apiData; m++)
{
